...
export default function Navbar() {
  ...
  return (
    <nav
      className={`sp-navbar ${isHomePage ? "is-home" : ""} ${
        isHomePage && isAtTop ? "home-top" : ""
      }`}
    >
        ...
        <ul className={`sp-links ${open ? "open" : ""}`}>
          ...
          <li className={`sp-dropdown ${schoolOpen ? "open" : ""}`}>
            ...
            <ul className="sp-dropdown-menu">
              <li>
                <Link to="/our-school/history" onClick={closeMenus}>
                  History
                </Link>
              </li>
              <li>
                <Link to="/our-school/mission-vision" onClick={closeMenus}>
                  Mission and Vision
                </Link>
              </li>
              <li>
                <Link to="/our-school/deped-philosophy" onClick={closeMenus}>
                  DepEd Philosophy
                </Link>
              </li>
              <li>
                <Link to="/our-school/student-handbook" onClick={closeMenus}>
                  Student Handbook
                </Link>
              </li>
              <li>
                <Link to="/our-school/office-school-head" onClick={closeMenus}>
          ...
          <li>
            <Link to="/admissions" onClick={closeMenus}>
              Admissions
            </Link>
          </li>
          {user && (
            <li>
              <Link to="/classes" onClick={closeMenus}>
                Classes
              </Link>
            </li>
          )}
          <li>
            <Link to="/news" onClick={closeMenus}>
              News
            </Link>
          </li>
          <li>
            <Link to="/facilities" onClick={closeMenus}>
              Facilities
            </Link>
          </li>
          <li>
            <Link to="/clubs" onClick={closeMenus}>
              Clubs
            </Link>
          </li>
