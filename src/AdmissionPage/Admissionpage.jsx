		...
		<div className="admission-page">
            ...
            <ol type="1">
              ...
              <li>
                ...
                <p>Submit the application requirements placed in a long brown envelope labelled with applicant's name at the Guard-On-Duty. Incomplete submission of documents will not be entertained.</p>
                <p>In addition, any representative below 18 years of age or 65 years and above will not be allowed to enter the school premises. The school observes strict compliance to health and safety protocols at all times.</p>
              </li>
              <li>
                What are the criteria for admission and screening?
                <p>60% - Grade 5/Grade 9 Grades in English, Mathematics and Science</p>
                <p>30% - Interview</p>
                <p>10% - Certificate of winnings in Mathematics and Science</p>
                <p>Total of 100%</p>
              </li>
              <li>
